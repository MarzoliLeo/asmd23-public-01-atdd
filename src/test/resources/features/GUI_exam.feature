Feature: Selezione e Spostamento delle Celle
  ...
  When l'utente clicca su una cella in posizione "<x>,<y>" che non è adiacente a nessuna cella selezionata
  Then quella cella dovrebbe essere numerata in modo incrementale
  And la cella in posizione "<x>,<y>" dovrebbe mostrare il numero
